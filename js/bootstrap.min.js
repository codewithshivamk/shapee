...
!function(t, e) {
  ...
  class Os extends W {
      ...
      show() {
          j.trigger(this._element, Es).defaultPrevented || (this._clearTimeout(),
      ...
      hide() {
          this.isShown() && (j.trigger(this._element, ws).defaultPrevented || (this._element.classList.add($s),
          this._queueCallback((()=>{
